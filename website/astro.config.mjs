			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'State Management Integrations', slug: 'guides/state-management-integrations' },
						...
						{ label: 'Naming Conventions', slug: 'guides/naming-conventions' },
					],
				},
				{
					label: 'Tutorials',
					items: [
						{ label: 'Tutorials Map', slug: 'tutorials' },
						{ label: 'The villain_lair examples', slug: 'tutorials/villain-lair' },
						{ label: 'The model_embassy tour', slug: 'tutorials/model-embassy' },
						{ label: 'The code_editor architecture tour', slug: 'tutorials/code-editor' },
					],
				},
				{
					label: 'Reference',
				...
				{ label: 'Troubleshooting & FAQ', slug: 'troubleshooting-and-faq' },
			],
		}),
	],
});
