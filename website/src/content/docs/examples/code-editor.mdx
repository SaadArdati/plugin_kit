...
Try the live web build at [plugin-kit-code-editor.pages.dev](https://plugin-kit-code-editor.pages.dev), or run it locally:
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="The full web build at plugin-kit-code-editor.pages.dev."
    href="https://plugin-kit-code-editor.pages.dev"
  />
  <LinkCard
