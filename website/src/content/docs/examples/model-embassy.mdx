...
If [the villain_lair examples](/examples/villain-lair/) cover the runtime concept by concept, this one is a focused study of a single shape: priority-based provider routing for an LLM-style application.
