...
See [Service Registry](/concepts/service-registry/) for the full priority model, and the priority direction question in the [FAQ](/faq/#why-do-registry-priority-and-event-priority-go-in-opposite-directions).
