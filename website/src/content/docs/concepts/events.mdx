...
Imperative for request types (`SendNotification`, `WaitForAssistant`). The full naming guide lives in [Naming Conventions](/guides/naming-conventions/).
...
<CardGrid>
  ...
  <LinkCard
    ...
    href="/guides/naming-conventions/"
  />
  <LinkCard
    title="Sessions"
