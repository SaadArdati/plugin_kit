...
void main() {
  test(
    'inserting many handlers with ascending priorities stays under '
  ...
  test(
    'priority-sorted dispatch order is preserved after binary-search '
    'insertion',
    () async {
  ...
  test(
    ...
    () async {
      ...
      expect(
        ...
        ['a', 'b', 'c'],
        reason:
            'equal-priority handlers must fire in registration order',
      );
    },
  );
}
