...
void main() {
  test(
    'cancelling the last identifier-scoped handler also clears the '
    'corresponding dirty-id entry (no memory leak across churn)',
    () async {
      final bus = EventBus();
  ...
  test(
    'register/cancel identifier-scoped handlers across many cycles does '
    'not corrupt dispatch order on the survivor',
    () async {
